...
class TaxCalculatorApplicationTests {
	 ...
	 private CongestionTaxCalculator taxCalculator;
	    ...
	    @Test
	    void testGetTaxDifferentDays() throws ParseException {
	        String[] timestamps = {
	            "2013-02-08 06:29:00",  // Expected tax: 8 SEK
	            "2013-02-11 06:30:27",  // Expected tax: 13 SEK
	            "2013-02-12 07:15:00"   // Expected tax: 18 SEK
	        };
	    ...
	    @Test
	    void testGetTaxWithDifferentDaysWithWeekend() throws ParseException {
	        String[] timestamps = {
	            "2013-02-08 06:29:00",  // Expected tax: 8 SEK
	            "2013-02-10 06:30:27",  // Expected tax: 0 SEK  -- weekend
	            "2013-02-11 07:15:00"   // Expected tax: 18 SEK
	        };

	        int tax = taxCalculator.getTaxForVehicle("Car", timestamps);

	        assertEquals(26, tax, "The tax for the car should be 26 SEK.");
	    }
